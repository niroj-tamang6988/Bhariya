            ...
            <div className="max-w-[800px] mx-auto relative before:content-[''] before:absolute before:top-0 before:left-1/2 before:w-1 before:h-full before:-translate-x-1/2 before:rounded-sm before:bg-[linear-gradient(to_bottom,#D4AF37_0%,#D4AF37_75%,#A1A1AA_75%,#A1A1AA_100%)]">
                ...
                <div className="flex items-center mb-15 relative">
                    ...
                    <div className="w-1/2 px-8 py-5 text-center border border-[#D4AF37] mr-110 rounded-2xl">
                        <h3 className="text-[#D4AF37] font-bold font-[sans-serif] text-lg mb-1">Order Placed</h3>
                        <p className="text-[#A1A1AA] text-sm leading-relaxed mb-2">Your shipment has been successfully placed and is being processed.</p>
                ...
                <div className="flex items-center mb-15 relative">
                    <div className="w-5 h-5 rounded-full absolute left-1/2 -translate-x-1/2 z-10 bg-[#D4AF37] shadow-[0_0_10px_rgba(212,175,55,0.5)]" />
                    <div className="w-1/2 ml-auto px-8 py-5 text-right border border-[rgba(212,175,55,0.2)] rounded-2xl">
                ...
                <div className="flex items-center mb-15 relative">
                    ...
                    <div className="w-1/2 px-8 py-5 text-left border border-[rgba(212,175,55,0.2)] rounded-2xl">
                ...
                <div className="flex items-center mb-15 relative">
                    ...
                    <div className="w-1/2 ml-auto px-8 py-5 text-right border border-[rgba(212,175,55,0.2)] rounded-2xl">
                        <h3 className="text-[#F5F5F5] font-semibold text-lg mb-1">Delivered</h3>
                        <p className="text-[#A1A1AA] text-sm leading-relaxed mb-2">Your package has been successfully delivered.</p>
                        <span className="text-xs font-semibold px-3 py-1 rounded-full bg-[#A1A1AA]/20 text-[#A1A1AA]">Pending</span>
                    </div>
                </div>
